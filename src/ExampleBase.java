...
public abstract class ExampleBase extends Thread implements EWrapper {
    ...
    //protected final static int WAIT_TIME = 10000; // 10 sec
    ...
    protected Order createOrder(String action, int quantity, String orderType, double lmtPrice) {
    ...
    protected Contract createContract(String symbol, String securityType, String exchange, String currency, String expiry) {
        return createContract(symbol, securityType, exchange, currency, expiry, null, 0.0);
    }
